    ...
    <div className="md:min-h-[90vh] w-full md:px-8 px-2 py-[80px] flex lg:flex-row items-center justify-center flex-col">
      ...
      >
        <h2 className="text-3xl font-bold mb-4 md:text-4xl">
          Client & Talent manager for Outsource.io
        </h2>
        <p className="opacity-70 mb-4 text-sm md:text-base leading-loose">
          Specially for Alix & Nigel, clients and talents managed here with
          React-based frontend backend authentication, data collection and
          management with Google Firebase. Login currently only allowed for
